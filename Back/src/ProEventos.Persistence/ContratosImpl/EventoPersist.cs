...
namespace ProEventos.Persistence.ContratosImpl
{
    public class EventoPersist : IEventoPersist
    {
        ...
        public EventoPersist(ProEventosContext context)
        {
            ...
            // Quando tudo for get, pode fazer isso, caso você precise segurar (fazer um Tracking)
            // Você pode fazer por metetodo da seguinte forma, query.AsNoTracking() no método.
        }
